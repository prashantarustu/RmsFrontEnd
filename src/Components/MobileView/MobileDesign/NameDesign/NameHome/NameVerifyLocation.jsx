...
const NameVerifyLocation = (props) => {
        ...
        <>
            {
                modalStatus ?
                    <>
                        <div class="modal fade" style={{ background: "rgba(0,0,0, 0.5)" }} id="MobileNameVerifyModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
                            <div class="modal-dialog modal-dialog-centered modal-xl" role="document" >
                                <div class="modal-content">
                                                                    ...
                                                                    <div className="row" >
                                                                        ...
                                                                        <div class="col-6 col-md-6  col-lg-4 " style={{ marginTop: '10px' }}>
                                                                            <div className="text__dropdwon">
                                                                                ...
                                                                                />
                                                                                <label htmlFor="" className='pt-1'>Apartment Type</label>
                                    ...
                                    <div className="btn-box text-right  mr-1 mb-1" style={{marginTop:'-10px'}}>
                                        <button type="button" class="btn btn-sm btn-success new-button mr-1" onClick={() => { check_Validation_Error() }} >Save</button>
...
export default NameVerifyLocation
