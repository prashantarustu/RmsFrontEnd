...
const VerifyLocation = (props) => {
    ...
    const check_Validation_Error = (e) => {
        if (locationVal?.IsUsLocation === 'Y') {
            ...
            if (RequiredFieldIncident(locationVal.Street)) {
                setErrors(prevValues => { return { ...prevValues, ['StreetError']: RequiredFieldIncident(locationVal.Street) } })
            }
    ...
    useEffect(() => {
        if (locationVal?.IsUsLocation === 'Y') {
            ...
            if (CountryIDError === 'true' && StreetError === 'true' && StateError === 'true' && CityIDError === 'true') {
                saveVerifyLocation();
            }
        }
    }, [StreetError, CountryIDError, StateError, CityIDError, ApartmentTypeError])
    ...
    const HandleChange = (e) => {
        if (e.target.name === 'IsUsLocation') {
            setLocationVal({
                ...locationVal,
                ['IsUsLocation']: e.target.value,
                'PremiseNo': '', 'PremiseNo_Parse': '', 'I_PremiseNo_Parse': '', 'Street': '', 'Street_Parse': '', 'I_Street_Parse': '', 'CommonPlace': '', 'Commonplace_Parse': '',
                'ApartmentNo': '', 'ApartmentNo_Parse': '', 'ApartmentType': '', 'ApartmentType_Parse': '', 'CountryID': '', 'Country': '', 'State': '', 'Statefullname': '',
                'CityID': '', 'City': '', 'ZipCodeID': '', 'ZipCode': '',
                //-------------------DrpData--------------------
                'DirectionPrefix': '', 'DirectionSufix': '', 'DirectionPrefix_Parse': '', 'DirectionSuffix_Parse': '', 'TypeSufix': '', 'TypePrefix': '', 'TypeSuffix_Parse': '',
            });
            // ResetFields_On_Change();
    ...
    // useEffect(() => {
    //     if (locationVal?.IsUsLocation ) {
    //         ResetFields_On_Change(locationVal?.IsUsLocation);
    //     }
        ...
        <>
            {
                modalStatus ?
                    <>
                        <div class="modal fade" style={{ background: "rgba(0,0,0, 0.5)", zIndex: '9999999' }} id="VerifyModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
                                                            ...
                                                            <div className="row">
                                                                <div className="col-12">
                                                                    ...
                                                                    <div className="row" >
                                                                        ...
                                                                        <div class="col-6 col-md-6  col-lg-4 " style={{ marginTop: '7px' }}>
                                                                ...
                                                                <div className="col-12">
                                                                    <div className="row">
                                                                        ...
                                                                        <div class="col-6 col-md-6  col-lg-3 dropdown__box">
                                                                            {/* <input type="text" name='CountryID' id='CountryID' className='requiredColor' value={locationVal?.CountryID} onChange={HandleChange} required /> */}
