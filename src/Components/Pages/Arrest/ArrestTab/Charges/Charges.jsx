...
const Charges = () => {
  ...
  const { setIncStatus,get_ArrestCharge_Count,get_Arrest_Count, updateCount, setUpdateCount, arrestChargeData, get_Data_Arrest_Charge, localStoreArray, setLocalStoreArray, get_LocalStorage, deleteStoreData, storeData } = useContext(AgencyContext);
