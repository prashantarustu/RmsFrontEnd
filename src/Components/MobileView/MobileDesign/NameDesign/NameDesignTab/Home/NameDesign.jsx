...
import MobileIdentification from '../MobileIdentification/MobileIdentification';
import MobileAlias from '../MobileAlias/MobileAlias';
import MobileContact from '../MobileContact/MobileContact';
import MobileComments from '../../../IncidentDesign/IncidentDesignTab/MobileComments/MobileComments';
import MobileAdditional from '../MobileAdditional/MobileAdditional';
import MobileSmt from '../MobileSmt/MobileSmt';
import { Comman_changeArrayFormat, changeArray, fourColArray, threeColArray } from '../../../../../Common/ChangeArrayFormat';
...
import MobileOffenders from '../MobileOffenders/MobileOffenders';
...
import MobileVictim from '../MobileVictims/MobileVictim';
...
const NameDesign = () => {
    ...
    const { LastNameError, NameTypeIDError, CertifiedByIDError, NameReasonCodeIDError, ContactError, SSN } = errors

    useEffect(() => {
        if (nameTypeCode === 'B') {
            if (LastNameError === 'true' && NameTypeIDError === 'true' && CertifiedByIDError === 'true' && NameReasonCodeIDError === 'true' && ContactError === 'true') {
                if (nameID) Update_Name();
                else InsertName();
            }
        } else {
            if (LastNameError === 'true' && NameTypeIDError === 'true' && CertifiedByIDError === 'true' && NameReasonCodeIDError === 'true' && ContactError === 'true' && SSN === 'true') {
                if (nameID) Update_Name();
                else InsertName();
            }
        }
    }, [LastNameError, NameTypeIDError, CertifiedByIDError, NameReasonCodeIDError, ContactError, SSN])
    ...
    useEffect(() => {
        GetNameTypeIdDrp(); GetSuffixIDDrp(); getAgeUnitDrp(); GetSexIDDrp(); GetRaceIdDrp(); getEthinicityDrp(); GetVerifyIDDrp(); getcertifiedByIdDrp(); GetBusinessTypeDrp(); GetPhoneTypeIDDrp();
    }, [])
    ...
    const [showPage, setShowPage] = useState('MobileAdditionalInfo');
        ...
        AddDeleteUpadate('Name_FRW/Insert_Name_FRW', value)
            .then((res) => {
                ...
                if (res.success) {
                    ...
                    console.log(res.NameID)
                    console.log(res.MasterNameID)
    ...
    return (
        <>
            <div className=" ">
                ...
                <div data-toggle="modal" data-target="#myModal" style={{ fontSize: 18, cursor: 'pointer', fontWeight: 'bold', background: 'cadetblue', position: 'absolute', padding: '7px 10px', right: '0px', color: '#434A54', top: '0px' }} onClick={setShowPage('MobileAdditionalInfo')}>
                  ...
                  <span >Tabs</span>
                    ...
                    {/* <div class="modal " id="nameModal" style={{ background: "rgba(0,0,0, 0.5)", transition: '0.5s' }} data-backdrop="false">
                        <div class="modal-dialog modal-dialog-centered modal-xl" style={{ maxWidth: 'inherit' }}>
                            <div class="modal-content" style={{ marginBottom: '-29px', height: '93vh', marginTop: '7px' }}>
                                <div class="modal-header" style={{ padding: '0px' }}>
                                    <button type="button" class="close mr-1" data-dismiss="modal" style={{ color: 'red', fontSize: '22px', fontWeight: 'bold' }}>&times;</button>
                                </div>
                                <div class="modal-body p-0">
                                    <div className="col-12 inc__tabs" >
                                        <div className="col-12  new-designtab pl-3">
                                            <MobileSubTab tabs={MobileNameTabs} setShowPage={setShowPage} showPage={showPage} />
                                        </div>
                                    </div>
                                    {
                                        showPage === 'MobileIdentification' ?
                                            <MobileIdentification />
                                            :
                                            showPage === 'MobileAlias' ?
                                                <MobileAlias />
                                                :
                                                showPage === 'MobileContacts' ?
                                                    <MobileContact />
                                                    :
                                                    showPage === 'MobileComments' ?
                                                        <MobileComments />
                                                        :
                                                        showPage === 'MobileAdditionalInfo' ?
                                                            <MobileAdditional />
                                                            :
                                                            showPage === 'MobileSMT' ?
                                                                <MobileSmt />
                                                                :
                                                                showPage === 'MobileDocument' ?
                                                                    <MobileDocument />
                                                                    :
                                                                    showPage === 'MobileOffender' ?
                                                                        <MobileOffenders />
                                                                        :
                                                                        showPage === 'MobileVictim' ?
                                                                            <MobileVictim />
                                                                            :
                                                                            <></>
                                    }
                    ...
                    <div className="card Agency " style={{ borderRight: 'none', borderLeft: 'none', borderRadius: '0', marginTop: '-15px', borderBottom: 'none' }}>
                        <div className="card-body">
                            <div className="row">
                                    ...
                                    <div className="row" style={{ marginTop: '-14px' }}>
                                        <div class="col-6 col-md-6  col-lg-3  " style={{ marginTop: '-0px' }}>
                                            <div className="text-mobile">
                                                ...
                                                />
                                                <label htmlFor='' className=''>Name Type</label>
                                                    ...
                                                    <div className="col-4 col-md-4 col-lg-2 pt-1 " >
                                                        <div className="text__dropdwon">
                                                            <Select
                                                                ...
                                                                styles={color}
                                                            />
                                                            <label htmlFor="" className='pt-1'>Age Unit</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-6 col-md-6 col-lg-4 pt-2  d-flex">
                                                        <div class="text-mobile ">
                                                            <input type="text" name='WeightFrom' value={value?.WeightFrom} maxLength={3} onChange={HandleChange} required disabled={nameTypeCode === "B" ? true : false} readOnly={nameTypeCode === "B" ? true : false} className={nameTypeCode === "B" ? 'readonlyColor' : ''} />
                                                            <label>Weight From</label>
                                                        </div>
                                                        <div class="text-mobile ml-3">
                                                            <input type="text" name='WeightTo' value={value?.WeightTo} maxLength={3} onChange={HandleChange} required className={nameTypeCode === "B" ? 'readonlyColor' : ''} disabled={nameTypeCode === "B" ? true : false} readOnly={nameTypeCode === "B" ? true : false} />
                                                    ...
                                                    <div className="col-4 col-md-4 col-lg-2 mt-1 ">
                                                        <div className=" text__dropdwon">
                                                            <Select
                                                                ...
                                                                isDisabled={nameTypeCode === "B" ? true : false}
                                                            />
                                                            <label htmlFor="" className='pt-1'>Gender</label>
                                                        </div>
                                                    </div>
                                                    <div className="col-4 col-md-4 col-lg-3 mt-1 ">
                                                        <div className=" text__dropdwon">
                                                            <Select
                                                                ...
                                                                styles={customStylesWithOutColor}
                                                            />
                                                            <label htmlFor="" className='pt-1'>Race</label>
                                                        </div>
                                                    </div>
                                                </>
                                        }
                                    ...
                                    <div className="row">
                                                    ...
                                                    <div className="col-4 col-md-4 col-lg-4 mt-1 ">
                                                        <div className=" text__dropdwon">
                                                            <Select
                                                                ...
                                                                styles={customStylesWithOutColor}
                                                            />
                                                            <label htmlFor="" className='pt-1'>Ethnicity</label>
                                                        </div>
                                                    </div>
                                                </>
                                        }
                                        ...
                                        <div className="col-12 col-md-12 col-lg-6 " style={{ marginTop: '2px' }}>
                                            <div className="text__dropdwon">
                                                ...
                                                />
                                                <label htmlFor="" className='pt-1 mt-1'>Reason Code</label>
                                        ...
                                        <div className="col-6 col-md-6 col-lg-3 " style={{ marginTop: '2px' }}>
                                            <div className="text__dropdwon">
                                                ...
                                                // styles={color}
                                                />
                                                <label htmlFor="" className='pt-1 mt-1'>Certified By</label>
                                        ...
                                        <Carousel autoPlay={true} className="carousel-style" showArrows={true} showThumbs={false} showStatus={false} >
                                            {
                                                nameMultiImg.length > 0 ?
                                                    nameMultiImg?.map((item, index) => (
                                                        <div key={index}>
                                                            <img src={item.Photo} style={{ height: '10px' }} />
                                                    ...
                                                    :
                                                    <div key='test'>
                                                        <img src={defualtImage} style={{ height: '10px' }} />
                                                    </div>
                                            }
                                        </Carousel>
            ...
            <div className="row bb px-1" style={{ marginTop: '-25px' }}>
                <div className="col-12 text-right  " style={{ marginBottom: '8px', marginTop: '-13px' }}>
                    <button type="button" className="btn btn-lg  btn-success new-button mr-3">New</button>
                    <button type="button" className="btn btn-lg  btn-success new-button mr-3" onClick={() => { check_Validation_Error() }}>{nameID ? 'Update' : 'Save'}</button>
                    <Link to={'/name-main'}>
                        <button type="button" className="btn btn-lg btn-success new-button" onClick={() => {('NameID'); }}>Close</button>
                    </Link>
                </div>
