...
import CrimeLeftScene_Add_Up from './CrimeLeftScene_Add_Up';


const CrimeLeftScene = () => {
    ...
    const get_data_PropertyDescription = () => {
        ...
        fetch_Post_Data('CrimeLeftScene/GetData_CrimeLeftScene', val)
            .then((res) => {
                if (res) {
    ...
    const UpdActiveDeactive = () => {
        ...
        AddDeleteUpadate('CrimeLeftScene/DeleteCrimeLeftScene', value)
            .then(res => {
                if (res.success) {
    ...
    const columns = [
        {
            name: 'Code',   
            selector: (row) => row.LeftSceneCode,
            sortable: true
        },
        {
            name: 'AgencyCode',
                ...
                <div style={{ position: 'absolute', top: 0, right: 40 }}>

                    {
                        pageStatus === "1" ?
                            EffectiveScreenPermission ? EffectiveScreenPermission[0]?.ChangeOK ?
                                <Link to="/ListManagement?page=Crime Left  Scene" data-toggle="modal" data-target="#CrimeLeftScene " onClick={(e) => { setEditValue(e, row) }}
                    ...
                    }
                    {
                        EffectiveScreenPermission ? EffectiveScreenPermission[0]?.DeleteOK ?
                            pageStatus === "1" ?
                                < Link to="/ListManagement?page=Crime Left  Scene" data-toggle="modal" data-target="#ConfirmModal" onClick={(e) => {
                                    setLeftSceneId
                                        (row.LeftSceneId
    ...
    const setEditValue = (e, row) => {
        ...
        setModal(true); setStatus(true); setLeftSceneId
            (row.LeftSceneId
            )
    }
    ...
    return (
        ...
        <>
                    ...
                    <div className="row mt-2">
                        <div className="col-12 ">
                            <div className="bg-green text-white py-1 px-2 d-flex justify-content-between align-items-center">
                                <p className="p-0 m-0">Crime Left Scene</p>
                                {
                                    pageStatus === '1' ?
                                        EffectiveScreenPermission ? EffectiveScreenPermission[0]?.AddOK ?
                                            <Link to="/ListManagement?page=Crime Left  Scene" className="text-white" onClick={setStatusFalse}
                                                data-toggle="modal" data-target="#CrimeLeftScene " >
                    ...
                    <div className="row">
                        <div className="col-5">
                            <input type="text" onChange={(e) => {
                                ...
                                const result = Filter(PropertyDescriptionData, e.target.value, searchValue2, filterPropertyDescriptionCode, 'LeftSceneCode', 'Description')
                        ...
                        <div className="col-5">
                            <input type="text" onChange={(e) => {
                                ...
                                const result = Filter(PropertyDescriptionData, searchValue1, e.target.value, filterPropertyDescription, 'LeftSceneCode', 'Description')
                                setPropertyDescriptionFilterData(result)
                            }}
            ...
            {/* <Criminal_Add_Up {...{ LeftSceneId
, status, get_data_CrimeBias, PropertyDescriptionData, modal, setModal, PropertyDescriptionStatus }} /> */}
            <CrimeLeftScene_Add_Up {...{
                LeftSceneId
                , status, get_data_PropertyDescription, PropertyDescriptionData, modal, setModal, PropertyDescriptionStatus
            }} />
