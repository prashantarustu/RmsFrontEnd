...
const CourtDisposition = () => {
  ...
  const setStatusFalse = (e) => {
    ...
    // setChargeCourtDispositionID(ChargeCourtDispositionID);
  }
  ...
  return (
    <>
      ...
      <CourtDisposition_Add_Up {...{ ChargeID, LoginPinID, LoginAgencyID, status, setStatus, ChargeCourtDispositionID, modal, setModal, get_CourtDisposition_Data, updateStatus, ArrestID }} />
    </>
  )
}
