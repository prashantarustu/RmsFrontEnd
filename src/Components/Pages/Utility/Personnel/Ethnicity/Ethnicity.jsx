...
import Ethnicity_Add_Up from './Ethnicity_Add_Up';
...
const Ethnicity = () => {
  ...
  const get_data_Ethnicity = () => {
    ...
    fetch_Post_Data('TableManagement/GetData_Ethnicity', val)
      .then((res) => {
        if (res) {
          console.log(res);
  ...
  return (
    ...
    <>
      ...
      <Ethnicity_Add_Up {...{ EthnicityID, status, get_data_Ethnicity, ethnicityData, modal, setModal, EthnicityupdStatus }} />
