...
const AddressVerify = (props) => {
    ...
    const { LoginAgencyID, modalStatus, setModalStatus, value, setValue, addVerifySingleData, setVerifySingleData, get_Add_Single_Data } = props
        ...
        <>
            {
                modalStatus ?
                    <>
                        <div class="modal fade" style={{ background: "rgba(0,0,0, 0.5)" }} id="AddressVerifyModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
