...
const Condition_Add_Up = () => {
    return (
        <>
            <div class="modal fade" style={{ background: "rgba(0,0,0, 0.5)" }} id="ConditionModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="false">
...
export default Condition_Add_Up