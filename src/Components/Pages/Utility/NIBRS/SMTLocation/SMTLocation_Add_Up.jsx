...
const SMTLocation_Add_Up = (props) => {

    const { LoginPinID, IsSuperadmin, LoginAgencyID, singleTypeId, status, get_data, listData, modal, setModal, updateStatus } = props
    ...
    // useEffect(() => {
    //     if (modal) { getAgency(LoginAgencyID, LoginPinID); get_SMT_Location(LoginAgencyID); }
    // }, [modal, LoginAgencyID])
...
export default SMTLocation_Add_Up;
